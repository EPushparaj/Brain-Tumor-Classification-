...
def Model_Trans_Unet(Data, Target, sol=None):
    ...
    model.fit(Data, tar, epochs=3, batch_size=64, validation_split=0.1)
    # model.fit(Data, tar, epochs=2, steps_per_epoch=5, verbose=1)
